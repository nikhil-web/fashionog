<?php
        ...
        $output = '';
        $sql = "SELECT * FROM products INNER JOIN products_img on products.p_id = products_img.p_id WHERE products_img.p_image_type = 1 AND products.p_name LIKE '%$parameter%'";
