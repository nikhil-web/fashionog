<?php
        ...
        $output = '';
        $sql = "SELECT * FROM products INNER JOIN products_img on products.p_id = products_img.p_id INNER JOIN products_color on products.p_id = products_color.p_id WHERE products_img.p_image_type = 1 AND products_color.color_name = '$parameter'";
        $result = mysqli_query($db, $sql);
              ...
              if (mysqli_num_rows($result) > 0) {
                  ...
                  $output .= '<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item '.$row["p_cat"].'">
                      <!-- Block2 -->
                      <div class="block2">
