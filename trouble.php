	...
	<section class="bg0 p-t-50 p-b-116">
        ...
        <div class="container">
             ...
             <div class="col-md-6 custom_reg_box">
                <form method="POST" id="trouble_form">
                  <fieldset><legend class="text-center">Enter Your Email and Phonenumber.</legend>
                    ...
                    <div class="form-group">
                      <label for="password"><span class="req">* </span> Phonenumber: </label>
                        <input required  type="phconenumber" name="user_phone" placeholder="Your phonenumber" class="form-control inputpass" minlength="4" maxlength="16"  id="pass1" /> </p>
                      </div>
...
var regMail = /^([_a-zA-Z0-9-]+)(\.[_a-zA-Z0-9-]+)*@([a-zA-Z0-9-]+\.)+([a-zA-Z]{2,3})$/;
  ...
  $(function () {
    ...
    $('#trouble_form').on('submit', function (e) {
         swal("Please Wait");
      e.preventDefault();
      $.ajax({
          type: "POST",
          url: "send_reset_mail.php",
          data: $('#trouble_form').serialize(),
          dataType: 'JSON',
          success: function(response_login_ajax) {
              if (response_login_ajax == 1) {
                swal("An Email has been sent to your Email with a link to reset your password");
